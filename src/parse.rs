...
/// Обобщённая обёртка для парсинга любого [Parsable]-типа
#[allow(private_bounds)]
pub fn just_parse_multihelper<T: Parsable>(input: String) -> Result<(String, T), ()> {
